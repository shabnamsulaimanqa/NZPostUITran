...
public class ParcelForYouOriginalDeliveryAddressPage {
  ...
  public boolean disabledCollectionPoint() {
    return $("input[value='parcelCollect']").isSelected();
  }

  public void gotoRedeliveryOptionPage(MapHolder mapHolder) throws Throwable {
    Address address = new Address("PO Box 201227, Auckland Airport, Auckland 2150");
    ...
    this.enter(address);
    Thread.sleep(200);
    this.selectFromPrimaryAddressList("PO Box 201227, Auckland Airport, Auckland 2150");
    this.clickNext();
  }
}
