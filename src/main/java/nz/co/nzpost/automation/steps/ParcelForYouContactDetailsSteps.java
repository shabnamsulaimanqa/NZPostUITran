...
public class ParcelForYouContactDetailsSteps {
  ...
  public void userShouldSeeEmailDetailValidationError() throws Throwable {
    assertThat(contactDetailsPage.emailNotification()).isEqualToIgnoringCase("Please enter your email address in this format: name@example.com and avoid characters such as #$%.");
  }

  @Then("^User should see phone number validation error$")
  public void userShouldSeePhoneNumberValidationError() throws Throwable {
    assertThat(contactDetailsPage.phoneNotification()).isEqualToIgnoringCase("Please enter a valid phone number, using characters such as 123.");
  }
  ...
  public void userShouldSeeDateAndTimePage() throws Throwable {
    assertThat(contactDetailsPage.getDateandTimeHeading()).isEqualToIgnoringCase("Choose a date and time");
  }
}
