...
public class ParcelForYouCollectionPointSteps {
  ...
  public void userShouldBeShownRedeliverCollectionPoint() throws Throwable {
    assertThat(summaryPage.getSummaryAddress()).isEqualToIgnoringCase("Papatoetoe Central NZ Post & Kiwibank 75 St George Street, Papatoetoe, Auckland 2025");
  ...
  public void userShouldSeeSuccessPageForParcelCollection() throws Throwable {
    ...
    assertThat(submittedOriginalAddress).isEqualToIgnoringCase("75 St George Street, Papatoetoe, Auckland 2025");
